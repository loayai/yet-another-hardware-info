        ...
        if [ "$TEST_MODE" -eq 1 ]; then
            ...
            if command -v dd >/dev/null 2>&1; then
                ...
                for disk in $DISK_LIST; do
                    ...
                    type_label=$(detect_disk_type "$disk")
